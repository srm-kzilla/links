        ...
        >
          <tbody>
            <tr>
              <td
                style="
                  border-bottom: 3px #6fcf97 solid;
                    ...
                    <tr>
                      ...
                      >
                        <div
                          ...
                          "
                        >
                          <p><span style="font-size: 16px">Hi {{=it.name}},</span></p>
                          <p>
                          ...
                          <p>
                            <span style="font-size: 16px"
                              ...
                              Here is the one-time-password<strong>
                                (OTP) to change your password</strong
                              >. This OTP will be valid only for
                              <strong>5 minutes</strong>.</span
                            >
                          </p>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <p>
                            <span style="font-size: 16px"
                              >If you didn't request this OTP, kindly change
                              your password to secure your account or reach out
                              to us.</span
                            >
                          </p>
                          <p>&nbsp;</p>
  ...
  <![endif]-->
      ...
      >
        <table
          ...
          cellspacing="0"
          role="presentation"
          style="background: #6fcf97; background-color: #6fcf97; width: 100%"
        >
          <tbody>
            <tr>
              <td
