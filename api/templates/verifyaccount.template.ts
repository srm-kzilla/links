import doT from "dot";
export var verifyAccountTemplate = doT.template(`<!DOCTYPE html>
    <html
        ...
        <div style="background-color: #ffffff">
            ...
            >
              <tbody>
                <tr>
                  <td
                    style="
                      border-bottom: 3px #56ccf2 solid;
                      border-left: 0px #6fcf97 solid;
                      border-right: 0px #6fcf97 solid;
                      border-top: 0px #6fcf97 solid;
                      direction: ltr;
                      font-size: 0px;
                        ...
                        <tr>
                          ...
                          >
                            <div
                              ...
                              "
                            >
                              <p><span style="font-size: 16px">Hi {{=it.username}},</span></p>
                              <p>
                              ...
                              <p>
                                <span style="font-size: 16px"
                                  ...
                                  <strong>verify your account</strong> and complete
                                  your signup process. This verification mail is
                                  valid only for <strong>24 hours</strong>.</span
                                >
                              </p>
                            </div>
                          </td>
                              ...
                              <tr>
                                <td
                                  ...
                                  style="
                                    ...
                                    border-radius: 8px;
                                    cursor: auto;
                                    mso-padding-alt: 10px 34px 10px 34px;
                                    background: #56ccf2;
                                  "
                                  valign="middle"
                                >
                        ...
                        <tr>
                          ...
                          >
                            ...
                            >
                              <p>
                                <span style="font-size: 16px"
                                  >If you didn't request this mail, kindly reach out
                                  to us.</span
                                >
                              </p>
                              <p>&nbsp;</p>
                            ...
                            >
                              <p style="text-align: left" class="footer">
                                <span style="font-size: 14px; color: #7e8c8d"
                                  ...
                                  Technology<br />Chennai, Tamil Nadu &mdash;
                                  603203</span
                                >
                              </p>
                            </div>
                                ...
                                <td style="padding: 4px">
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        <a
                                          href="https://www.facebook.com/SRMKZILLA/"
                                          target="_blank"
                                          style="color: #0000ee"
                                        >
                                          <img
                                    ...
                                    <tr>
                                      ...
                                      >
                                        ...
                                        >
                                          <img
                                            height="35"
                                            src="https://s3-eu-west-1.amazonaws.com/ecomail-assets/editor/social-icos/outlinedbw/youtube.png"
                                            style="
                                              border-radius: 3px;
                                              display: block;
                                            "
                                ...
                                <td style="padding: 4px">
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        <a
                                          href="https://github.com/srm-kzilla/links"
                                          target="_blank"
                                          style="color: #0000ee"
                                        >
                                          <img
                                            height="35"
                                            src="https://user-images.githubusercontent.com/60572554/117619076-6ef4b200-b18c-11eb-90da-cf2540fea3e5.png"
                                            style="
                                              border-radius: 3px;
                                              display: block;
                                            "
          ...
          >
            <table
              ...
              cellspacing="0"
              role="presentation"
              style="background: #56ccf2; background-color: #56ccf2; width: 100%"
            >
              <tbody>
                <tr>
                  <td
