                ...
                <Fade bottom duration={200}>
                  <div className="p-8 w-full md:w-1/3 bg-white rounded-lg shadow-2xl max-w-md">
                    ...
                    <div className="flex items-center justify-center">
                      <button
                        onClick={onClose}
                        className="bg-white border-2 border-primaryGreen focus:outline-none hover:opacity-80 text-primaryGreen w-2/3 text-md font-bold mr-2 py-3 px-4 mt-7 rounded"
                      >
                        CANCEL
                      </button>
                      <button
