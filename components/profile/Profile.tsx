  ...
  return (
    <>
      ...
      <div className="relative flex items-center justify-center flex-col mt-4 md:float-left md:ml-60 md:mt-32 z-40">
        ...
        <div className="flex flex-col">
          <div className="mt-10">
            ...
            >
              <i className="float-left mt-1 mr-2">
                <FiLink />
              </i>
              <strong>
                {baseUrl}
            ...
            <button
              onClick={() =>
                copyToClipBoard(`http://localhost:3000/${_resProfile.username}`)
              }
              className="float-right focus:outline-none"
              title="Copy to Clipboard"
            >
              <i className="float-right mt-1 ml-2 grid-cols-1 cursor-pointer">
                <MdContentCopy />
              </i>
            </button>
          </div>
      ...
      <div className="flex items-center justify-center flex-col lg:absolute lg:top-40 lg:right-2 lg:pl-48 lg:w-4/5 mt-4">
        <p className="left-0 text-darkgray font-extrabold">NAME</p>
        <input
          value={name}
          type="textarea"
          name="name"
        ...
        />
        <p className="text-darkgray font-extrabold mb-2">USERNAME</p>
        <input
          value={username}
          type="text"
          name="username"
        ...
        />
        <p className="text-darkgray font-extrabold mb-2">BIO</p>
        <textarea
          value={bio}
