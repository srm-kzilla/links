...
export default function ProfileComponent(): JSX.Element {
    ...
    return (
        <>
            <div className="absolute text-xl lg:text-6xl top-16 left-4 hidden lg:block gradientHeaderHollow">
                <h1>Edit Profile</h1>
            </div>
            <div className="flex items-center justify-center flex-col">
                ...
                <div className="flex flex-col">
                    <h1 className="mt-4 mb-4 font-extrabold text-2xl sm:text-4xl text-left">
                        aye_that_guitar_guy
                    </h1>
                    <div>
            ...
            <div className="flex items-center justify-center flex-col mt-4">
                <input
                    ...
                    name="name"
                    autoComplete="off"
                    className="gradientInputBottom shadow-inner p-1 focus:outline-none bg-backgroundwhite w-2/3 sm:w-1/4 mt-4 mb-8"
                    placeholder="Name"
                />
                <input
                    type="text"
                    name="username"
                    autoComplete="off"
                    className="gradientInputBottom shadow-inner p-1 focus:outline-none bg-backgroundwhite w-2/3 sm:w-1/4 mb-8"
                    placeholder="Username"
                />
                <textarea
                    className="gradientTextareaBottom shadow-inner w-2/3 sm:w-1/4 focus:outline-none bg-backgroundwhite border"
                    rows={5}
                    // cols={42}
                    placeholder="Bio"
                />
